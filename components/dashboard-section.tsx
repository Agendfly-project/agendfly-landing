      ...
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            Visualize o desempenho do seu negócio e tome decisões baseadas em
            dados com nosso dashboard completo.
          </p>
        </div>
                ...
                <div className="p-6 bg-agendafly-50 border-b border-agendafly-100">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button className="bg-agendafly-main text-white rounded-md px-3 py-1 text-sm">
                        Exportar
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <Card className="border-agendafly-100 lg:col-span-2">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Comparativo de vendas nos últimos 7 dias
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="h-[200px] w-full bg-gradient-to-r from-agendafly-100 to-agendafly-50 rounded-lg flex items-end justify-between p-4 overflow-x-auto">
                          <div className="flex w-full justify-between gap-2 sm:gap-4 flex-wrap sm:flex-nowrap">
                            {[40, 65, 50, 80, 60, 55, 75].map((height, i) => (
                              ...
                              >
                                <div
                                  className="bg-agendafly-main rounded-t-sm w-6 sm:w-8"
                                  style={{ height: `${height}%` }}
                                ></div>
                ...
                <div className="p-6 bg-agendafly-50 border-b border-agendafly-100">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                      ...
                      <p className="text-gray-600">
                        Acompanhamento de comissões por profissional
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <Card className="border-agendafly-100 lg:col-span-2">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Desempenho mensal de cada profissional
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                          ...
                          {[
                            ...
                            <div key={i} className="space-y-2">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="text-agendafly-main font-medium">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-7 gap-2">
                        ...
                        {Array.from({ length: 7 }).map((_, dayIndex) => (
                          <div
                            key={dayIndex}
                            className="h-32 border border-gray-200 rounded-md p-1 text-xs"
                          >
